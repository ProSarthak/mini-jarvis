...
def run_jarvis():
    ...
    try:
        ...
        if 'hello' in command :
            ...
            print('I am mini jarvis a k a your virtual assistant master')
            engine_talk('I am mini jarvis a k a your virtual assistant master. how can i help you ??')
            ...
            print("your welcome")
            engine_talk('your welcome...i hope i was helpful...goodbye ')
            sys.exit()
...
print('\n')
print("hello, i am mini jarvis how can i help you ??")
engine_talk ("hello i am mini jarvis how can i help you ")
while True:
    run_jarvis()
